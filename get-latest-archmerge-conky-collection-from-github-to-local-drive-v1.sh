...
[ -d /tmp/archmerge-conky-collection ] && rm -rf "/tmp/archmerge-conky-collection" || echo ""
# download the github in folder /tmp/archmerge-conky-collection
...
git clone https://github.com/archmerge/Archmerge-Conky-Collection /tmp/archmerge-conky-collection
...
cp -rf /tmp/archmerge-conky-collection/* ~/.config/conky
rm -rf /tmp/archmerge-conky-collection
